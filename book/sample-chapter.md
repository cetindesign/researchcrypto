...
Let's walk through the ones you're most likely to meet — and the simple habits that make you a hard target.
...
- Check the URL letter by letter. Scammers use lookalikes: `binance.com` vs `binance-support.com` vs `bínance.com`.
...
- Be suspicious of sponsored/ad results at the top of search — scammers buy those spots.

## 5. Rug pulls — the coin that vanishes

A new token is hyped to the moon. Prices rocket, influencers shout "next 100x," you buy in — then the creators dump their share, drain the pool, and disappear. The chart flatlines to zero.
...
- [ ] I reach support only through the official app/site I opened myself.
...
In the next chapter, we'll lock your setup down for good with a simple security checklist: two-factor authentication done right, how to store your seed phrase, and when a cold wallet is worth it.
